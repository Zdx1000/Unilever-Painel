...
class PrincipalKips():
    ...
    def _kpi_YTD_por_BU(self, dataframe_df_geral: pd.DataFrame, mes_atual: str) -> pd.DataFrame:
        ...
        dataframe_df_geral = dataframe_df_geral[dataframe_df_geral["MES"] == mes_atual]
    ...
    def _kpi_COB_ponderada_por_BU(self, dataframe_df_geral: pd.DataFrame, mes_atual: str) -> pd.DataFrame:
    ...
    def _kpi_COB_numerica_por_BU(self, dataframe_df_geral: pd.DataFrame) -> pd.DataFrame:
        ...
        kip_COB_numerica["KPI"] = "COB NUMERICA"
    ...
    def metas_e_realizado(self, dataframe_df_geral: pd.DataFrame, mes_atual: str) -> pd.DataFrame:
        ...
        kip_YTD = self._kpi_YTD_por_BU(dataframe_df_geral, mes_atual)
        kip_COB_ponderada = self._kpi_COB_ponderada_por_BU(dataframe_df_geral, mes_atual)
